...
# board.put_on_board(Rook.new('black'), [7, 5])
board.put_on_board(Knight.new('black'), [1, 7])
board.put_on_board(Rook.new('white'), [0, 7])
board.put_on_board(Rook.new('black'), [7, 0])
board.put_on_board(Rook.new('white'), [7, 7])
# board.put_on_board(Pawn.new('white'), [5, 3])
# board.put_on_board(Pawn.new('black'), [4, 1])
# board.put_on_board(Pawn.new('white'), [2, 6])

# board.put_on_board(Pawn.new('black'), [3, 4])
